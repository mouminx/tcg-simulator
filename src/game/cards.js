export const RARITIES = {
  ...
  legendary: { name: 'Legendary', color: '#eab308', weight: 2,  valueMin: 65.00, valueMax: 200.00 },
  mythic:    { name: 'Mythic',    color: '#ef4444', weight: 1,  valueMin: 200.00, valueMax: 500.00 },
};
...
export const PACK_TYPES = {
  ...
  dusk: {
    ...
    rarityWeights: { common: 70, uncommon: 22, rare: 6,  epic: 1.5, legendary: 0.5, mythic: 0   },
  ...
  iron: {
    ...
    rarityWeights: { common: 55, uncommon: 25, rare: 12, epic: 5,   legendary: 2,   mythic: 1   },
  ...
  arcane: {
    ...
    rarityWeights: { common: 35, uncommon: 28, rare: 22, epic: 10,  legendary: 4,   mythic: 1   },
  ...
  void: {
    ...
    rarityWeights: { common: 12, uncommon: 20, rare: 30, epic: 22,  legendary: 12,  mythic: 4   },
  ...
  primordial: {
    ...
    rarityWeights: { common: 4,  uncommon: 10, rare: 26, epic: 32,  legendary: 20,  mythic: 8   },
  ...
  vault1: {
    ...
    rarityWeights: { common: 10, uncommon: 20, rare: 36, epic: 24,  legendary: 8,   mythic: 2   },
  ...
  vault2: {
    ...
    rarityWeights: { common: 2,  uncommon: 6,  rare: 18, epic: 36,  legendary: 28,  mythic: 10  },
  ...
  vault3: {
    ...
    rarityWeights: { common: 0,  uncommon: 1,  rare: 6,  epic: 20,  legendary: 42,  mythic: 31  },
  ...
  holoEd: {
    ...
    rarityWeights: { common: 25, uncommon: 30, rare: 25, epic: 12, legendary: 6, mythic: 2 },

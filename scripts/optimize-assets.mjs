...
const JOBS = [
  ...
  { from: 'crafted', to: 'crafted', icon: true, label: 'crafted items' },
  { from: 'pack-crafting/calling/elemental-calling', to: 'crafted', icon: true, label: 'elemental Callings' },
  { from: 'pack-crafting/calling/vocational-calling', to: 'crafted', icon: true, label: 'vocational Callings' },
  { from: 'pack-crafting/calling/trait-calling', to: 'crafted', icon: true, label: 'trait Callings' },
  { from: 'tools', to: 'tools', icon: true, label: 'tools' },
  { from: 'gems', to: 'gems', icon: true, label: 'gems' },
